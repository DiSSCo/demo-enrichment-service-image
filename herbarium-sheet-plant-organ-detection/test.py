...
test_object = {
    "id": "test_object",
    "content": {"ods:images": [{"ods:imageURI": "https://search.senckenberg.de/pix/images/sesam/32/64133.jpg"}]},
}

result = run_object_detection(test_object["content"]["ods:images"][0]["ods:imageURI"], predictor)
print("Result: ", result)
